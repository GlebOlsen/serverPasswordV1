...
namespace AuthServer
{
    class AuthServer
    {
        ...
        public void Listen(int port)
        {
            ...
            while (true)
            {
                connectionSocket = server.AcceptTcpClient();
        ...
        {
            string line;
            StreamReader file = new StreamReader(@"C:\Users\divine\Downloads\JwtAuthServer-master\JwtAuthServer-master\webster-dictionary.txt");
        ...
        {
            string line;
            StreamReader file = new StreamReader(@"C:\Users\divine\Downloads\PasswordCrackerCentralized\PasswordCrackerCentralized\PasswordCrackerCentralized\bin\Debug\passwords.txt");
            while ((line = file.ReadLine()) != null)
            {
